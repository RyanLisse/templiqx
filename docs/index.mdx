...
:::note
**Handbook** pages are curated specs and guides under `docs/`. **Code docs** (OpenWiki tab) are generated from the codebase on a daily schedule and stay in sync with the Rust workspace automatically.
:::
